...
CREATE OR REPLACE FUNCTION "public"."get_leaderboard"("p_limit" integer DEFAULT 20) RETURNS TABLE("id" "uuid", "user_id" "uuid", "points" integer, "created_at" timestamp with time zone, "username" "text", "xp" integer)
    LANGUAGE "sql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  select
