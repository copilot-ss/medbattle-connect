...
const CAMPAIGN_QUESTIONS = [
  ...
  },
  {
    ...
    region: 'kopf',
    difficulty: 'leicht',
    question: 'Erstlinientherapie beim akuten Migraeneanfall?',
  ...
  },
  {
    ...
    region: 'abdomen',
    difficulty: 'mittel',
    question: 'Welche Elektrolytstoerung ist typisch unter Schleifendiuretika?',
    options: ['Hypokaliaemie', 'Hyperkaliaemie', 'Hyperkalzaemie', 'Hypernatriaemie'],
    correct_answer: 'Hypokaliaemie',
  },
  // Becken
  {
    id: 'camp-becken-001',
  ...
  // Extremitaeten
  {
    ...
    region: 'extremitaeten',
    difficulty: 'schwer',
    question: 'Welcher Nerv ermoeglicht die Handgelenksextension?',
