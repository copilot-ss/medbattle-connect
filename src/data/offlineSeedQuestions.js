...
const OFFLINE_SEED_QUESTIONS = [
  ...
  },
  {
    ...
    category: 'Immunologie',
    language: 'de',
    question: 'Welche Moleküle präsentieren endogene Peptide an CD8+ T-Zellen?',
    options: ['MHC I', 'MHC II', 'CD1', 'TCR'],
    correct_answer: 'MHC I',
    explanation: 'MHC-I-Moleküle präsentieren intrazelluläre (endogene) Peptide und aktivieren CD8+ zytotoxische T-Zellen.',
  },
  {
    id: 'seed-mittel-021-en',
    difficulty: 'mittel',
    category: 'Immunologie',
    language: 'en',
    question: 'Which molecules present endogenous peptides to CD8+ T cells?',
    options: ['MHC I', 'MHC II', 'CD1', 'TCR'],
    correct_answer: 'MHC I',
    explanation: 'MHC I molecules present intracellular (endogenous) peptides and activate CD8+ cytotoxic T cells.',
  },
  {
    id: 'seed-mittel-022',
    difficulty: 'mittel',
    category: 'Immunologie',
    language: 'de',
    question: 'Welche Immunglobulinklasse dominiert in Schleimhäuten?',
    options: ['IgA', 'IgG', 'IgM', 'IgE'],
    correct_answer: 'IgA',
    explanation: 'Sekretorisches IgA ist das wichtigste Antikörper-Isotyp in Schleimhäuten und neutralisiert Pathogene im Lumen.',
  },
  {
    id: 'seed-mittel-022-en',
    difficulty: 'mittel',
    category: 'Immunologie',
    language: 'en',
    question: 'Which immunoglobulin class predominates in mucosal secretions?',
    options: ['IgA', 'IgG', 'IgM', 'IgE'],
    correct_answer: 'IgA',
    explanation: 'Secretory IgA is the main antibody isotype in mucosa, neutralizing pathogens in the lumen.',
  },
  {
    id: 'seed-mittel-023',
    difficulty: 'mittel',
    category: 'Immunologie',
    language: 'de',
    question: 'Welches Komplementfragment ist ein starkes Chemotaxin?',
    options: ['C5a', 'C3b', 'C1q', 'C9'],
    correct_answer: 'C5a',
    explanation: 'C5a ist ein potentes Chemotaxin und aktiviert Neutrophile. C3b dient v. a. der Opsonierung.',
  },
  {
    id: 'seed-mittel-023-en',
    difficulty: 'mittel',
    category: 'Immunologie',
    language: 'en',
    question: 'Which complement fragment is a strong chemotactic factor?',
    options: ['C5a', 'C3b', 'C1q', 'C9'],
    correct_answer: 'C5a',
    explanation: 'C5a is a potent chemotactic and activating factor for neutrophils. C3b mainly opsonizes.',
  },
  {
    id: 'seed-mittel-024',
    difficulty: 'mittel',
    category: 'Immunologie',
    language: 'de',
    question: 'Welche T-Helfer-Subpopulation produziert vor allem IFN-gamma?',
    options: ['Th1-Zellen', 'Th2-Zellen', 'Treg-Zellen', 'Th17-Zellen'],
    correct_answer: 'Th1-Zellen',
    explanation: 'Th1-Zellen produzieren IFN-gamma und aktivieren Makrophagen. Th2 fördert v. a. Eosinophile und IgE.',
  },
  {
    id: 'seed-mittel-024-en',
    difficulty: 'mittel',
    category: 'Immunologie',
    language: 'en',
    question: 'Which T helper subset primarily produces IFN-gamma?',
    options: ['Th1 cells', 'Th2 cells', 'Treg cells', 'Th17 cells'],
    correct_answer: 'Th1 cells',
    explanation: 'Th1 cells produce IFN-gamma and activate macrophages. Th2 responses promote eosinophils and IgE.',
  },
  {
    id: 'seed-mittel-025',
    difficulty: 'mittel',
    category: 'Immunologie',
    language: 'de',
    question: 'Welche Zellen töten virusinfizierte Zellen gezielt ab?',
    options: ['CD8+ T-Zellen', 'B-Zellen', 'Plasmazellen', 'Neutrophile'],
    correct_answer: 'CD8+ T-Zellen',
    explanation: 'CD8+ zytotoxische T-Zellen erkennen MHC-I-präsentierte Peptide und lysieren infizierte Zellen über Perforin/Granzyme.',
  },
  {
    id: 'seed-mittel-025-en',
    difficulty: 'mittel',
    category: 'Immunologie',
    language: 'en',
    question: 'Which cells specifically kill virus-infected cells?',
    options: ['CD8+ T cells', 'B cells', 'Plasma cells', 'Neutrophils'],
    correct_answer: 'CD8+ T cells',
    explanation: 'CD8+ cytotoxic T cells recognize MHC I-presented peptides and lyse infected cells via perforin/granzymes.',
  },
  {
    id: 'seed-mittel-026',
    difficulty: 'mittel',
    category: 'Immunologie',
    language: 'de',
    question: 'Welches Molekül auf T-Helferzellen ist für den Klassenwechsel der B-Zellen essenziell?',
    options: ['CD40L (CD154)', 'CD28', 'CTLA-4', 'CD8'],
    correct_answer: 'CD40L (CD154)',
    explanation: 'Der Klassenwechsel benötigt CD40-CD40L-Interaktion und Zytokine. Fehlt CD40L, entsteht das Hyper-IgM-Syndrom.',
  },
  {
    id: 'seed-mittel-026-en',
    difficulty: 'mittel',
    category: 'Immunologie',
    language: 'en',
    question: 'Which molecule on helper T cells is essential for B-cell class switching?',
    options: ['CD40L (CD154)', 'CD28', 'CTLA-4', 'CD8'],
    correct_answer: 'CD40L (CD154)',
    explanation: 'Class switching requires CD40-CD40L interaction plus cytokines. CD40L deficiency causes hyper-IgM syndrome.',
  },
  {
    id: 'seed-schwer-005',
    difficulty: 'schwer',
  ...
  },
  {
    ...
    category: 'Anatomie',
    language: 'de',
    question: 'Welche Struktur trennt Brusthoehle und Bauchhoehle?',
    options: ['Zwerchfell', 'Milz', 'Pankreas', 'Mandibel'],
    correct_answer: 'Zwerchfell',
    explanation: 'Das Zwerchfell ist der wichtigste Atemmuskel und bildet die Grenze zwischen Brust- und Bauchhoehle.',
  },
  {
    id: 'seed-leicht-009-en',
    difficulty: 'leicht',
    category: 'Anatomie',
    language: 'en',
    question: 'Which structure separates the chest cavity from the abdominal cavity?',
    options: ['Diaphragm', 'Spleen', 'Pancreas', 'Mandible'],
    correct_answer: 'Diaphragm',
    explanation: 'The diaphragm is the main muscle of breathing and forms the boundary between the chest and abdominal cavities.',
  },
  {
    id: 'seed-leicht-010',
    difficulty: 'leicht',
    category: 'Physiologie',
    language: 'de',
    question: 'Welche Zellen transportieren den groessten Teil des Sauerstoffs im Blut?',
    options: ['Erythrozyten', 'Thrombozyten', 'Fibroblasten', 'Osteoklasten'],
    correct_answer: 'Erythrozyten',
    explanation: 'Erythrozyten enthalten Haemoglobin und uebernehmen damit den Hauptteil des Sauerstofftransports im Blut.',
  },
  {
    id: 'seed-leicht-010-en',
    difficulty: 'leicht',
    category: 'Physiologie',
    language: 'en',
    question: 'Which cells carry most of the oxygen in the blood?',
    options: ['Erythrocytes', 'Platelets', 'Fibroblasts', 'Osteoclasts'],
    correct_answer: 'Erythrocytes',
    explanation: 'Erythrocytes contain hemoglobin and therefore carry most of the oxygen transported in the blood.',
  },
  {
    id: 'seed-leicht-011',
    difficulty: 'leicht',
    category: 'Pathologie',
    language: 'de',
    question: 'Wie nennt man eine Gelbfaerbung von Haut und Skleren?',
    options: ['Ikterus', 'Zyanose', 'Nekrose', 'Oedem'],
    correct_answer: 'Ikterus',
    explanation: 'Ikterus beschreibt eine gelbliche Verfaerbung durch erhoehtes Bilirubin. Skleren und Haut fallen dabei oft zuerst auf.',
  },
  {
    id: 'seed-leicht-011-en',
    difficulty: 'leicht',
    category: 'Pathologie',
    language: 'en',
    question: 'What is yellow discoloration of the skin and sclera called?',
    options: ['Jaundice', 'Cyanosis', 'Necrosis', 'Edema'],
    correct_answer: 'Jaundice',
    explanation: 'Jaundice is yellow discoloration caused by elevated bilirubin. The sclera and skin are often the most obvious sites.',
  },
  {
    id: 'seed-leicht-012',
    difficulty: 'leicht',
    category: 'Pharmakologie',
    language: 'de',
    question: 'Welcher Wirkstoff wird haeufig gegen Schmerzen und Fieber eingesetzt?',
    options: ['Paracetamol', 'Insulin', 'Heparin', 'Amoxicillin'],
    correct_answer: 'Paracetamol',
    explanation: 'Paracetamol wird haeufig gegen Schmerzen und Fieber verwendet. Die anderen Wirkstoffe haben andere Hauptanwendungen.',
  },
  {
    id: 'seed-leicht-012-en',
    difficulty: 'leicht',
    category: 'Pharmakologie',
    language: 'en',
    question: 'Which drug is commonly used for pain and fever?',
    options: ['Paracetamol', 'Insulin', 'Heparin', 'Amoxicillin'],
    correct_answer: 'Paracetamol',
    explanation: 'Paracetamol is commonly used for pain and fever. The other drugs serve different primary purposes.',
  },
  {
    id: 'seed-leicht-013',
    difficulty: 'leicht',
    category: 'Mikrobiologie',
    language: 'de',
    question: 'Was fuer ein Erreger ist Staphylococcus aureus?',
    options: ['Bakterium', 'Virus', 'Pilz', 'Helminth'],
    correct_answer: 'Bakterium',
    explanation: 'Staphylococcus aureus ist ein Bakterium. Es kann unter anderem Hautinfektionen, Abszesse und invasive Infektionen verursachen.',
  },
  {
    id: 'seed-leicht-013-en',
    difficulty: 'leicht',
    category: 'Mikrobiologie',
    language: 'en',
    question: 'What kind of pathogen is Staphylococcus aureus?',
    options: ['Bacterium', 'Virus', 'Fungus', 'Helminth'],
    correct_answer: 'Bacterium',
    explanation: 'Staphylococcus aureus is a bacterium. It can cause skin infections, abscesses, and invasive disease.',
  },
  {
    id: 'seed-leicht-014',
    difficulty: 'leicht',
    category: 'Biochemie',
    language: 'de',
    question: 'Welcher Zucker zirkuliert hauptsaechlich im Blut?',
    options: ['Glukose', 'Laktose', 'Fruktose', 'Ribose'],
    correct_answer: 'Glukose',
    explanation: 'Glukose ist der wichtigste direkt verfuegbare Zucker im Blut und ein zentraler Energielieferant fuer viele Gewebe.',
  },
  {
    id: 'seed-leicht-014-en',
    difficulty: 'leicht',
    category: 'Biochemie',
    language: 'en',
    question: 'Which sugar mainly circulates in the blood?',
    options: ['Glucose', 'Lactose', 'Fructose', 'Ribose'],
    correct_answer: 'Glucose',
    explanation: 'Glucose is the main readily available sugar in the blood and a central energy source for many tissues.',
  },
  {
    id: 'seed-leicht-015',
    difficulty: 'leicht',
    category: 'Immunologie',
    language: 'de',
    question: 'Welche weissen Blutkoerperchen gehoeren zur koerpereigenen Abwehr?',
    options: ['Leukozyten', 'Erythrozyten', 'Thrombozyten', 'Chondrozyten'],
    correct_answer: 'Leukozyten',
    explanation: 'Leukozyten sind die weissen Blutkoerperchen und Teil der koerpereigenen Immunabwehr. Erythrozyten transportieren dagegen Sauerstoff.',
  },
  {
    id: 'seed-leicht-015-en',
    difficulty: 'leicht',
    category: 'Immunologie',
    language: 'en',
    question: 'Which white blood cells belong to the body\'s immune defense?',
    options: ['Leukocytes', 'Erythrocytes', 'Platelets', 'Chondrocytes'],
    correct_answer: 'Leukocytes',
    explanation: 'Leukocytes are the white blood cells and part of the body\'s immune defense. Erythrocytes mainly transport oxygen instead.',
  },
  {
    id: 'seed-leicht-016',
    difficulty: 'leicht',
    category: 'Genetik',
    language: 'de',
    question: 'Wie nennt man die Gesamtheit der Erbinformation eines Menschen?',
    options: ['Genom', 'Proteom', 'Ribosom', 'Lysosom'],
    correct_answer: 'Genom',
    explanation: 'Das Genom umfasst die gesamte genetische Information eines Organismus. Proteom bezeichnet dagegen die Gesamtheit der Proteine.',
  },
  {
    id: 'seed-leicht-016-en',
    difficulty: 'leicht',
    category: 'Genetik',
    language: 'en',
    question: 'What is the complete set of genetic information of a human called?',
    options: ['Genome', 'Proteome', 'Ribosome', 'Lysosome'],
    correct_answer: 'Genome',
    explanation: 'The genome is the complete set of genetic information of an organism. The proteome instead refers to the full set of proteins.',
  },
  {
    id: 'seed-leicht-017',
    difficulty: 'leicht',
    category: 'Radiologie',
    language: 'de',
    question: 'Welche Bildgebung arbeitet mit einem starken Magnetfeld statt mit Roentgenstrahlung?',
    options: ['MRT', 'CT', 'Roentgen', 'PET-CT'],
    correct_answer: 'MRT',
    explanation: 'Die Magnetresonanztomographie nutzt starke Magnetfelder und Radiowellen. CT und Roentgen arbeiten dagegen mit ionisierender Strahlung.',
  },
  {
    id: 'seed-leicht-017-en',
    difficulty: 'leicht',
    category: 'Radiologie',
    language: 'en',
    question: 'Which imaging modality uses a strong magnetic field instead of X-rays?',
    options: ['MRI', 'CT', 'X-ray', 'PET-CT'],
    correct_answer: 'MRI',
    explanation: 'Magnetic resonance imaging uses strong magnetic fields and radio waves. CT and X-ray instead use ionizing radiation.',
  },
  {
    id: 'seed-leicht-018',
    difficulty: 'leicht',
    category: 'Chirurgie',
    language: 'de',
    question: 'Wie nennt man das Verschliessen einer Wunde mit Faden?',
    options: ['Naht', 'Biopsie', 'Drainage', 'Resektion'],
    correct_answer: 'Naht',
    explanation: 'Eine Naht verschliesst Gewebe oder Hautrander mit Fadenmaterial. Drainage und Resektion beschreiben andere chirurgische Massnahmen.',
  },
  {
    id: 'seed-leicht-018-en',
    difficulty: 'leicht',
    category: 'Chirurgie',
    language: 'en',
    question: 'What is closing a wound with suture material called?',
    options: ['Suture', 'Biopsy', 'Drain', 'Resection'],
    correct_answer: 'Suture',
    explanation: 'A suture closes tissue or skin edges with thread material. Drainage and resection describe different surgical measures.',
  },
];
