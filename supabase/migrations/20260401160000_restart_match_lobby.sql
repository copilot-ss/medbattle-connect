...
begin
  ...
  next_state := jsonb_build_object(
    'host', jsonb_build_object(
      ...
      'title', match_row.state->'host'->>'title',
      'avatarUrl', match_row.state->'host'->>'avatarUrl',
      'avatarIcon', match_row.state->'host'->>'avatarIcon',
      'avatarColor', match_row.state->'host'->>'avatarColor',
      'index', 0,
      'score', 0,
      'finished', false,
    ...
    'guest', jsonb_build_object(
      ...
      'title', match_row.state->'guest'->>'title',
      'avatarUrl', match_row.state->'guest'->>'avatarUrl',
      'avatarIcon', match_row.state->'guest'->>'avatarIcon',
      'avatarColor', match_row.state->'guest'->>'avatarColor',
      'index', 0,
      'score', 0,
      'finished', false,
      'answers', jsonb_build_array(),
