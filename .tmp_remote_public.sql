...
CREATE TABLE IF NOT EXISTS "public"."matches" (
    ...
    "category" "text",
    CONSTRAINT "matches_difficulty_check" CHECK (("difficulty" = ANY (ARRAY['leicht'::"text", 'mittel'::"text", 'schwer'::"text"]))),
...
CREATE OR REPLACE FUNCTION "public"."create_match"("p_difficulty" "text" DEFAULT 'mittel'::"text", "p_question_limit" integer DEFAULT 5, "p_category" "text" DEFAULT NULL::"text", "p_language" "text" DEFAULT 'de'::"text", "p_fallback_language" "text" DEFAULT 'de'::"text") RETURNS "public"."matches"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."create_match"("p_difficulty" "text", "p_question_limit" integer, "p_category" "text", "p_language" "text", "p_fallback_language" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_open_matches"("p_difficulty" "text" DEFAULT NULL::"text") RETURNS TABLE("id" "uuid", "code" "text", "difficulty" "text", "question_limit" integer, "created_at" timestamp with time zone, "host_username" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
begin
...
ALTER FUNCTION "public"."get_open_matches"("p_difficulty" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_questions"("p_difficulty" "text" DEFAULT NULL::"text", "p_limit" integer DEFAULT 6, "p_category" "text" DEFAULT NULL::"text", "p_language" "text" DEFAULT 'de'::"text", "p_fallback_language" "text" DEFAULT 'de'::"text") RETURNS TABLE("id" "uuid", "category" "text", "difficulty" "text", "question" "text", "options" "jsonb", "correct_answer" "text", "explanation" "text", "updated_at" timestamp with time zone)
    LANGUAGE "sql" STABLE
    SET "search_path" TO 'public'
    AS $$
  with normalized as (
...
ALTER FUNCTION "public"."get_questions"("p_difficulty" "text", "p_limit" integer, "p_category" "text", "p_language" "text", "p_fallback_language" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."normalize_difficulty"("p_difficulty" "text") RETURNS "text"
...
ALTER FUNCTION "public"."normalize_difficulty"("p_difficulty" "text") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."scores" (
    ...
    "difficulty" "text",
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()),
    CONSTRAINT "scores_difficulty_check" CHECK (("difficulty" = ANY (ARRAY['leicht'::"text", 'mittel'::"text", 'schwer'::"text"]))),
...
CREATE OR REPLACE FUNCTION "public"."submit_score"("p_user_id" "uuid", "p_points" integer, "p_difficulty" "text") RETURNS "public"."scores"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."submit_score"("p_user_id" "uuid", "p_points" integer, "p_difficulty" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_match_settings"("p_match_id" "uuid", "p_difficulty" "text" DEFAULT 'mittel'::"text", "p_question_limit" integer DEFAULT 5, "p_language" "text" DEFAULT 'de'::"text", "p_fallback_language" "text" DEFAULT 'de'::"text") RETURNS "public"."matches"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."update_match_settings"("p_match_id" "uuid", "p_difficulty" "text", "p_question_limit" integer, "p_language" "text", "p_fallback_language" "text") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."questions" (
    ...
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "explanation" "text",
    CONSTRAINT "questions_difficulty_check" CHECK (("difficulty" = ANY (ARRAY['leicht'::"text", 'mittel'::"text", 'schwer'::"text"]))),
...
CREATE INDEX "idx_questions_difficulty_category" ON "public"."questions" USING "btree" ("difficulty", "category");
...
CREATE UNIQUE INDEX "questions_slug_unique" ON "public"."questions" USING "btree" ("slug") WHERE ("slug" IS NOT NULL);



CREATE UNIQUE INDEX "questions_unique_question_category_difficulty" ON "public"."questions" USING "btree" ("lower"(TRIM(BOTH FROM "question")), "lower"(TRIM(BOTH FROM "category")), "lower"(TRIM(BOTH FROM "difficulty")));
...
GRANT ALL ON FUNCTION "public"."create_match"("p_difficulty" "text", "p_question_limit" integer, "p_category" "text", "p_language" "text", "p_fallback_language" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."create_match"("p_difficulty" "text", "p_question_limit" integer, "p_category" "text", "p_language" "text", "p_fallback_language" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_match"("p_difficulty" "text", "p_question_limit" integer, "p_category" "text", "p_language" "text", "p_fallback_language" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_open_matches"("p_difficulty" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."get_open_matches"("p_difficulty" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_open_matches"("p_difficulty" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_questions"("p_difficulty" "text", "p_limit" integer, "p_category" "text", "p_language" "text", "p_fallback_language" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."get_questions"("p_difficulty" "text", "p_limit" integer, "p_category" "text", "p_language" "text", "p_fallback_language" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_questions"("p_difficulty" "text", "p_limit" integer, "p_category" "text", "p_language" "text", "p_fallback_language" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."normalize_difficulty"("p_difficulty" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."normalize_difficulty"("p_difficulty" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."normalize_difficulty"("p_difficulty" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."submit_score"("p_user_id" "uuid", "p_points" integer, "p_difficulty" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."submit_score"("p_user_id" "uuid", "p_points" integer, "p_difficulty" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."submit_score"("p_user_id" "uuid", "p_points" integer, "p_difficulty" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_match_settings"("p_match_id" "uuid", "p_difficulty" "text", "p_question_limit" integer, "p_language" "text", "p_fallback_language" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."update_match_settings"("p_match_id" "uuid", "p_difficulty" "text", "p_question_limit" integer, "p_language" "text", "p_fallback_language" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_match_settings"("p_match_id" "uuid", "p_difficulty" "text", "p_question_limit" integer, "p_language" "text", "p_fallback_language" "text") TO "service_role";
