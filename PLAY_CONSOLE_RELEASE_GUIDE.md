...
- Developer Website fuer AdMob: `https://medquiz-web.vercel.app/`
- Live app-ads.txt: `https://medquiz-web.vercel.app/app-ads.txt`
...
- app-ads.txt / Developer Website: Die Seller-Datei ist unter `https://medquiz-web.vercel.app/app-ads.txt` live. Fuer die AdMob-Verifikation muss die in Google Play hinterlegte `Website` auf `https://medquiz-web.vercel.app/` zeigen. Ein Projekt-Unterpfad allein ist dafuer nicht die sichere Endkonfiguration.
